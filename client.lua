...
RegisterCommand('testnotify', function()
    ...
    exports['hud']:SendAlert('Title Here', 'Message of notification here!', 'success', 3000)
    Wait(1000)
    exports['hud']:SendAlert('Title Here', 'Message of notification here!', 'error', 3000, 'bottom-right')
    Wait(1000)
    exports['hud']:SendAlert('Title Here', 'Message of notification here!', 'warning', 3000, 'bottom-left')
    Wait(1000)
    exports['hud']:SendAlert('Title Here', 'Message of notification here!', 'info', 3000, 'top-center')
end)

RegisterCommand('testhelp', function()
    -- default position is on top-left
    exports['hud']:displayHelp('Press ~E~ to open something')
    Wait(1500)
    exports['hud']:closeHelp()
    exports['hud']:displayHelp('Press ~E~ to open something', 'center-right')
    Wait(1500)
    exports['hud']:closeHelp()
    exports['hud']:displayHelp('Press ~E~ to open something', 'top-right')
    Wait(1500)
    exports['hud']:closeHelp()
    exports['hud']:displayHelp('Press ~E~ to open something', 'bottom-right')
    Wait(1500)
    exports['hud']:closeHelp()
    exports['hud']:displayHelp('Press ~E~ to open something', 'top-center')
    Wait(1500)
    exports['hud']:closeHelp()    
    exports['hud']:displayHelp('Press ~E~ to open something', 'bottom-right')
    Wait(1500)
...
RegisterCommand('testdialog', function()
    exports['hud']:openModal('Confirmation Title','Are you sure you want to confirm this?', function()
        print('accepted')
    end, function()
        print('declined!')
    end)
